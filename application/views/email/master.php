...
$site_logo              =$this->Action->get_site_logo();
// $this->uri->segment(1)
...
<head>
	...
	<link rel="icon" href="<?php echo base_url();?>project_dir/<?php echo $site_logo;?>" type="image/x-icon">
	<style type="text/css">
...
<body bgcolor="#34495E" style="margin: 0; padding: 0;" yahoo="fix">
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td align="center" bgcolor="#345081"
				style="padding: 20px 20px 20px 20px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
				<img src="<?php echo base_url();?>project_dir/<?php echo $site_logo;?>" alt="<?php echo $site_name;?>" width="152" height="152" style="display:block;" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td align="center" bgcolor="#f9f9f9" style="padding: 30px 20px 30px 20px; font-family: Arial, sans-serif;">
				<table bgcolor="#345081" border="0" cellspacing="0" cellpadding="0" class="buttonwrapper">
					<tr>
