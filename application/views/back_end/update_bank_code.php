						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Add Bank Code & Name</h5>
								</div>
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_bank_code" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="bank_name" class="form-label">Bank Name</label>
										<input type="text" class="form-control" id="bank_name" placeholder="GTB" name="bank_name" required />
									</div>

									<div class="col-md-12" style="margin-top:3%;">
										<label for="bank_code" class="form-label">Bank Code</label>
										<input type="text" class="form-control" id="bank_code" placeholder="e.g 023" name="bank_code" required>
									</div>
