<?php
$m_dis_user_id      = $this->session->userdata('m_dis_user_id');
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to Subscribe User to this Plan
                        (<?php echo $plan_name;?>)?
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo base_url();?>Admin_panel/join_sub/<?php echo $m_dis_user_id;?>/<?php echo $plan_id;?>/<?php echo $plan_code;?>"
