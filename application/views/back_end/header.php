				...
				<nav class="navbar navbar-expand">
						...
						<ul class="navbar-nav align-items-center">
							...
							<li class="nav-item dropdown dropdown-large">
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 
										<?php if($count_alert > 0){?><span class="alert-count"><?php echo $count_alert;?></span><?php }?>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												<div class="flex-grow-1">
													<p class="msg-info"><?php echo $msg;?><span class="msg-time float-end"><?php $this->Admin_db->time_stamp($time);?></span></p>
												</div>
											</div>
										</a>
							...
							<?php if(!$admin_status){?>
								<li class="nav-item dropdown dropdown-large">
									<a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 
										<?php if($count_msg > 0){?> <span class="alert-count"><?php echo $count_msg;?></span><?php }?>
									...
									<div class="dropdown-menu dropdown-menu-end">
										...
										<div class="header-message-list">
											...
											<a class="dropdown-item" href="<?php echo base_url();?>Message/reply_user/<?php echo $dis_sender;?>/<?php echo $dis_reciever;?>/<?php echo $props_id;?>">
												<div class="d-flex align-items-center">
													<div class="">
														<img src="<?php echo base_url();?>project_dir/users/<?php echo $dis_user_name;?>/images/<?php echo $dis_user_image;?>" class="msg-avatar" alt="user avatar">
													</div>
													<div class="flex-grow-1">
														<h6 class="msg-name"><?php echo $dis_full_name;?> <span class="msg-time float-end"><?php $this->Admin_db->time_stamp($time);?>
													</span></h6>
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="<?php echo base_url();?>project_dir/users/<?php echo $user_name;?>/images/<?php echo $user_img;?>" class="user-img">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="#upload_propfile" data-bs-toggle="modal"><i class="bx bx-user"></i><span>Upload Pic</span></a>
							</li>
							<li><a class="dropdown-item" href="<?php echo base_url();?>Profile/view_user/<?php echo $user_id;?>"><i class="bx bx-user"></i><span>Profile</span></a>
							</li>
							...
							<li><a class="dropdown-item" href="<?php echo base_url();?>Logout/user_logout"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
