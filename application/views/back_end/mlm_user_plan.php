<?php
    ...
    $currency		            = '&#8358;';
    $success_sub                = $this->Subscription_db->count_subscription_success($dis_user_id, $plan_id);
    $failed_sub                 = $this->Subscription_db->count_subscription_failed($dis_user_id, $plan_id);
    $revenue_amount             = $this->Subscription_db->revenue_amount($dis_user_id, $plan_id);
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <h6 class="mb-0"><?php echo $this->Users_db->get_user_full_name_by_id($dis_user_id)?> Plan
                </h6>
                <hr>
                <?php echo isset($alert)?$alert:NULL;?>
                <?php
                $get_plan       = $this->Subscription_db->get_subscriber($dis_user_id, $plan_id);
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?php echo base_url();?>Subscription/disable_sub/<?php echo $dis_user_id;?>/<?php echo $plan_code;?>/<?php echo $subscription_code;?>/<?php echo $email_token;?>"
                ...
                <?php 
                    if(!is_array($get_plan)){
                        echo $this->Admin_db->alert_callbark('danger','This User is not subscribing to any plan at the moment!');
                    }
                ?>
            </div>
        </div>
