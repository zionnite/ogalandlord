					...
					<div class="col-xl-12 mx-auto">
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								...
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_sub_state" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="state" class="form-label">State Name</label>
										<input type="text" class="form-control" id="state" placeholder="Edo" name="state" required />
									</div>
