										...
										<div class="d-flex flex-column align-items-center text-center">
											...
											<div class="mt-3">
												...
												?>
													...
													<a href="#send_msg_<?php echo $dis_user_id;?>" data-bs-toggle="modal" class="btn btn-outline-primary">Message</a>
										...
										<ul class="list-group list-group-flush">
											...
											<?php if($admin_status || $user_id == $dis_user_id) {?>
												<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
													<a href="#change_password_<?php echo $dis_user_id;?>" data-bs-toggle="modal" class="btn btn-sm btn-success btn-block">Change Password</a>
												</li>
											<?php }?>

											<?php if($admin_status){?>
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<a href="#ban_<?php echo $dis_user_id;?>" data-bs-toggle="modal" class="btn btn-sm btn-dark btn-block" >
											...
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<a href="#delete_<?php echo $dis_user_id;?>" data-bs-toggle="modal" class="btn btn-sm btn-danger btn-block"> Delete User</a>
											</li>
											<?php } ?>
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
										...
										?>
										<div class="row">
											<div class="col-sm-3"><a href="<?php echo base_url();?>Profile/edit_detail" class="btn btn-danger btn-block px-4">Edit Detail</a></div>
											<div class="col-sm-9 text-secondary">
									...
									<div class="col-sm-12">
										<div class="card">
											<div class="card-body">
												...
												<div class="row">
													<div class="col-sm-3"><a href="<?php echo base_url();?>Profile/edit_bank_detail" class="btn btn-danger btn-block px-4">Update Bank Detail</a></div>
													<div class="col-sm-9 text-secondary">
										...
										?>
												<div class="card">
													<div class="card-body">
														...
														<a href="javascript:;" id="verify" class="card-link"> Verify Your Bank Account</a>
													</div>
												</div>
										...
										<div class="card">
											<div class="card-body">
												...
												?>
												<span style="color:red;"><?php echo base_url();?>Register/ref/<?php echo $user_id;?>/<?php echo $new_status;?></span>
												<input type="hidden" id="link_copy" value="<?php echo base_url();?>Register/ref/<?php echo $user_id;?>/<?php echo $new_status;?>">
												<br />
								...
								?>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                	...
                                                                	<a href="<?php echo base_url();?>Admin_panel/toggle_ban_user/<?php echo $dis_user_id;?>/view_user" class="btn btn-danger">Yes, Continue</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal fade" id="delete_<?php echo $dis_user_id;?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                    <a href="<?php echo base_url();?>Admin_panel/delete_user/<?php echo $dis_user_id;?>/view_user" class="btn btn-danger">Yes, Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
													...
													<!-- Send message Dialog -->
                                                    <div class="modal fade" id="change_password_<?php echo $dis_user_id;?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="<?php echo base_url();?>Admin_panel/change_user_password" method="post">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <!-- body  -->
                                                                        <div class="form-group" style="margin-bottom:1%;">
                                                                            <input type="text" name="pass" required class="form-control" placeholder="New Password" />
                                                                        </div>    

                                                                        <div class="form-group" style="margin-bottom:1%;">
                                                                            <input type="text" name="repass" required class="form-control" placeholder="Confirm New Password" />
                                                                        </div>                                                                    
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                                                                        <input type="submit"  class="btn btn-success btn-sm" name="login" value="Change Password">
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
