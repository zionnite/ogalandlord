						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Add Sub Property Type</h5>
								</div>
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_sub_property_type" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="state" class="form-label">Name</label>
										<input type="text" class="form-control" id="state" placeholder="e.g Classic Master" name="name" required />
									</div>
