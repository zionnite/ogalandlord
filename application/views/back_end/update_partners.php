						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Partner Logos</h5>
								</div>
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_partners" enctype="multipart/form-data">
									
                                    
									<div class="col-md-12" style="margin-top:3%;">
										<label for="logo" class="form-label">Select Logo <span style="color:red;">(width & height should be 300px By 250px resptictively)</span></label>
										<input type="file" class="form-control" id="logo" name="userfile" required>
