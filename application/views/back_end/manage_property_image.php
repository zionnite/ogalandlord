							...
							<div class="card-body">
								<div class="row align-items-center">
									<div class="col-lg-12 col-xl-12">
										<a href="<?php echo base_url();?>Dashboard/add_feature_image/<?php echo $props_id;?>" class="btn btn-dark  mb-3 mb-lg-0"><i class="bx bxs-plus-square"></i>Add Feature Image</a>
										<a href="<?php echo base_url();?>Dashboard/add_image_property/<?php echo $props_id;?>" class="btn btn-primary  mb-3 mb-lg-0"><i class="bx bxs-plus-square"></i>Add Image to Property</a>
									</div>
                                        ...
                                        <div class="col">
                                            <div class="card">
                                                <div class="props_image">
                                                    <img src="<?php echo base_url();?>project_dir/property/<?php echo $feature_image;?>" class="card-img-top">
                                                </div>
                                               ...
                                               <?php if($user_id == $agent_id && !$admin_status){?>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="<?php echo base_url();?>Dashboard/delete_feature_image/<?php echo $props_id;?>" class="btn btn-danger">Yes, Delete</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <?php }else if($admin_status){ ?>
                                                    <div class="card-body">	
                                                        ...
                                                        <a href="#un_approve_feature" data-bs-toggle="modal" class="card-link" style="color:red;">Reject Slider</a>
                                                        <?php }?>
                                                        <!-- Modal -->
                                                        ...
                                                        <div class="modal fade" id="approve_feature" tabindex="-1" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                        <a href="<?php echo base_url();?>Dashboard/approve_feature_image/<?php echo $props_id;?>" class="btn btn-danger">Yes, Continue</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="modal fade" id="un_approve_feature" tabindex="-1" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                        <a href="<?php echo base_url();?>Dashboard/unapprove_feature_image/<?php echo $props_id;?>" class="btn btn-danger">Yes, Continue</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
						...
						<div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
                            ...
                            ?>
                                        <div class="col">
                                            <div class="card">
                                                <div class="props_image">
                                                    <img src="<?php echo base_url();?>project_dir/property/<?php echo $name;?>" class="card-img-top">
                                                </div>
