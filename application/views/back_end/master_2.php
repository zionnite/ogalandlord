...
<body>
	...
	<div class="wrapper">
		<!--sidebar wrapper -->
		<?php $this->load->view('back_end/side_bar');?>
		<!--end sidebar wrapper -->
		<!--start header -->
    ...
    <div class="modal fade" id="upload_propfile" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
				...
				<form action="<?php echo base_url();?>Profile/update_profile_pic" method="post"  enctype="multipart/form-data">
	...
	<?php $this->load->view('back_end/js_file_2');?>
</body>
