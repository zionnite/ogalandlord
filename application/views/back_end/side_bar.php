			...
			<ul class="metismenu" id="menu">
				...
				<?php }else if($user_status == 'admin' || $user_status == 'super_admin'){?>
						...
						<li>
							...
							<ul>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_property"><i class="bx bx-right-arrow-alt"></i>View All Propety</a></li>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_pending_property"><i class="bx bx-right-arrow-alt"></i>Pending Property  
									<?php if($count_pending_property > 0){?>
										&nbsp;<span class="badge bg-danger"><?php echo $count_pending_property;?></span>
									<?php }?></a>
								</li>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_approve_property"><i class="bx bx-right-arrow-alt"></i>Approved Property</a></li>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_unapprove_property"><i class="bx bx-right-arrow-alt"></i>Rejected Property</a></li>
						...
						<li>
							...
							<ul>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_users"><i class="bx bx-right-arrow-alt"></i>View All Users</a></li>
								<li> <a href="<?php echo base_url();?>Admin_panel/view_all_agents"><i class="bx bx-right-arrow-alt"></i>View All Landlord & Agent</a></li>
				...
				<?php if($admin_status){?>
					...
					<li>
						...
						<ul>
							<li> <a href="<?php echo base_url();?>Admin_panel/update_site_logos"><i class="bx bx-right-arrow-alt"></i>Update Site Logo</a></li>
							<li> <a href="<?php echo base_url();?>Admin_panel/update_site_detail"><i class="bx bx-right-arrow-alt"></i>Update Site Detail</a></li>
							<li> <a href="<?php echo base_url();?>Admin_panel/update_payment_api"><i class="bx bx-right-arrow-alt"></i>Update Payment API</a></li>
							<li> <a href="<?php echo base_url();?>Admin_panel/update_payment_commission"><i class="bx bx-right-arrow-alt"></i>Update Payment Commission</a></li>
							<li> <a href="<?php echo base_url();?>Admin_panel/update_social_link"><i class="bx bx-right-arrow-alt"></i>Update Social Link</a></li>
