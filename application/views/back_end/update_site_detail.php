					...
					<div class="col-xl-12 mx-auto">
						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								...
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_site_detail" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="site_email" class="form-label">Site Email</label>
										<input type="text" class="form-control" id="site_email" placeholder="e.g info@ogabliss.com" name="site_email" required value="<?php echo $get_site_email;?>">
									</div>

									<div class="col-md-12" style="margin-top:3%;">
										<label for="phone" class="form-label">Site Phone</label>
										<input type="text" class="form-control" id="phone" placeholder="e.g +234 9034286339" name="phone" required value="<?php echo $get_site_phone;?>">
									</div>
									...
									<div class="col-md-12" style="margin-top:3%;">
										...
										<textarea class="form-control" id="site_address" placeholder="e.g 10, Okada air way, Edo state, Nigeria" name="site_address" required><?php echo $get_site_addres;?></textarea>
									</div>
								
                                    <div class="col-md-12" style="margin-top:1%; color:red;">
                                        <h5>Gmail Detial</h5>
                                        <p>You Need to update the Gmail Address & Gmail Password, so the platform will be able to send out mail</p>
									</div>
                                    <div class="col-md-12" style="margin-top:0%;">
										<label for="gmail" class="form-label">Gmail Address</label>
										<input type="text" class="form-control" id="gmail" placeholder="e.g agentzionnite@gmail.com" name="gmail" required  value="<?php echo $get_site_g_name;?>">
									</div>

                                    <div class="col-md-12" style="margin-top:0%;">
										<label for="gpass" class="form-label">Gmail Pass</label>
										<input type="text" class="form-control" id="gpass" placeholder="e.g agentzionnite@gmail.com" name="gpass" required  value="<?php echo $get_site_g_pass;?>">
									</div>

                                    <h5>Other Site Detial</h5>
									<div class="col-md-12" style="margin-top:0%;">
										<label for="site_keyword" class="form-label">Site Keword</label>
										<textarea class="form-control" id="site_keyword" placeholder="e.g Realestate, Property,CofO, Duplex etc" name="site_keyword" required><?php echo $get_site_keyword;?></textarea>
									</div>
								
                                    
									<div class="col-md-12" style="margin-top:1%;">
										<label for="site_desc" class="form-label">Site Description</label>
										<textarea class="form-control" id="site_desc" placeholder="e.g The Purpose of this platform is to make the hustle less for both land and tenant" name="site_desc" required><?php echo $get_site_desc;?></textarea>
									</div>
