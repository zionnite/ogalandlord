						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Payment API</h5>
								</div>
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_payment_api" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="public_key" class="form-label">Public Key</label>
										<input type="text" class="form-control" id="public_key" placeholder="e.g pk_xeipoooiljkjkklkm" name="public_key" required value="<?php echo $get_public_live_key;?>">
									</div>

									<div class="col-md-12" style="margin-top:3%;">
										<label for="private_key" class="form-label">Secret Key</label>
										<input type="text" class="form-control" id="private_key" placeholder="e.g sk_XEEWoweopwefwklkjikwe9;" name="private_key" required value="<?php echo $get_private_live_key;?>">
									</div>
