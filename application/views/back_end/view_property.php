											...
											<div class="row">
												<div class="col-md-10">
													<div class="position-relative">
														<input type="text" class="form-control ps-5" name="keyword" placeholder="Search Product..."> <span class="position-absolute top-50 product-show translate-middle-y"><i class="bx bx-search"></i></span>
													</div>
												</div>
												<div class="col-md-2">
													<div class="position-relative">
														<input type="submit" name="submit" class="btn btn-danger btn-sm btn-block p-2" value="Search">
													</div>
												</div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float_right" style="margin-top:1.7%;">
                            <div class="col-sm-1">
                                <div class="dropdown">
                                    <button class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="true">Type</button>
                                    <ul class="dropdown-menu" style="margin: 0px; position: absolute; inset: 0px auto auto 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                                        ...
                                        if(is_array($get_types_of_props)){
                                            foreach($get_types_of_props as $row){
                                                ...
                                                $name	= $row['name'];
                                        ?>    
                                                <li><a class="dropdown-item" href="<?php echo base_url();?>Admin_panel/fill_types/<?php echo $id;?>"><?php echo $name;?></a></li>
                        ...
                        <div class="follow_float" style="margin-top:1.7%;">
                            <div class="">
                                <div class="dropdown">
                                    <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="true">Purpose</button>
                                    <ul class="dropdown-menu" style="margin: 0px; position: absolute; inset: 0px auto auto 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                                        
                                        <li><a class="dropdown-item" href="<?php echo base_url();?>Admin_panel/fill_purpose/rent">For Rent</a></li>
                                        <li><a class="dropdown-item" href="<?php echo base_url();?>Admin_panel/fill_purpose/sale">For Sale</a></li>
                        ...
                        <div class="follow_float" style="margin-top:1.7%;">
                            <div class="">
                                <div class="dropdown">
                                    <button class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="true">State</button>
                                    <ul class="dropdown-menu" style="margin: 0px; position: absolute; inset: 0px auto auto 0px; transform: translate(0px, 38px);" data-popper-placement="bottom-start">
                                        <?php 
                                        ...
                                        if(is_array($get_types_of_props)){
                                            foreach($get_types_of_props as $row){
                                                ...
                                                $name	= $row['name'];
                                        ?>    
                                                <li><a class="dropdown-item" href="<?php echo base_url();?>Admin_panel/fill_state_property/<?php echo $id;?>"><?php echo $name;?></a></li>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">	
                                                    ...
                                                    <?php if($props_live_status == 'pending'){?>
                                                        ...
                                                        <a href="#approve_<?php echo $props_id;?>" data-bs-toggle="modal" class="card-link">Approve</a>
                                                        <a href="#reject_<?php echo $props_id;?>" data-bs-toggle="modal" class="card-link">Reject</a>
                                                    ...
                                                    <!-- Approve Property -->
                                                    <div class="modal fade" id="approve_<?php echo $props_id;?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Are you sure you want to Approve this Property (<?php echo $props_name;?>)?
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                                    <a href="<?php echo base_url();?>Admin_panel/approve_property/<?php echo $props_id;?>/<?php echo $location;?>/<?php echo $props_id;?>/<?php echo $props_agent_id;?>" class="btn btn-danger">Yes, Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Reject Property -->
                                                    <div class="modal fade" id="reject_<?php echo $props_id;?>" tabindex="-1" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Confirm Action</h5>
                                                                ...
                                                                <form action="<?php echo base_url();?>Admin_panel/reject_property" method="post">
                                                                    <div class="modal-body">
                                                                        <p>Are you sure you want to Change this Property (<?php echo $props_name;?>) Live Status to Rejected?

                                                                        
                                                                                                                
                                                                        
                                                                        <div class="form-group">
                                                                            <textarea name="message" id="message" required class="form-control" placeholder="Give Reason why this property its rejected?"></textarea>
                                                                        </div> 
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <input type="hidden" name="agent_id" value="<?php echo $props_agent_id;?>" />
                                                                        <input type="hidden" name="location" value="<?php echo $location;?>" />
                                                                        <input type="submit" name="submit" class="btn btn-danger btn-sm" value="Yes, Continue" />
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
