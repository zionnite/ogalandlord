						...
						<div class="card border-top border-0 border-4 border-primary">
							<div class="card-body p-5">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Social Link</h5>
								</div>
								<hr>
								<form class="row g-3" method="post" action="<?php echo base_url();?>Admin_panel/insert_social_link" enctype="multipart/form-data">
									
                                    <div class="col-md-12">
										<label for="fb_link" class="form-label">Facebook Link</label>
										<input type="text" class="form-control" id="fb_link" placeholder="https://facebook.com/123xxxx" name="fb_link" required value="<?php echo $get_fb_link;?>">
									</div>

									<div class="col-md-12" style="margin-top:3%;">
										<label for="tw_link" class="form-label">Twitter Link</label>
										<input type="text" class="form-control" id="tw_link" placeholder="e.g https://twitter.com/2iow" name="tw_link" required value="<?php echo $get_tw_link;?>">
									</div>

									<div class="col-md-12" style="margin-top:3%;">
										<label for="ig_link" class="form-label">Instagram Link</label>
										<input type="text" class="form-control" id="ig_link" placeholder="e.g https://instagram.com/2121xxx" name="ig_link" required value="<?php echo $get_ig_link;?>">
									</div>
