<?php 
$count_downline             = $this->MUser_db->count_my_downline($user_id);
$payable_balance            = $this->MUser_db->getMTotalBalance($user_id);
$total_earning              = $this->MUser_db->totalAmountEarned($user_id);
    ...
    <div class="col-md-4">
        <div class="card radius-10 bg-danger bg-gradient">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div>
                        <p class="mb-0 text-white">Total Downline</p>
                        <h4 class="my-1 text-white"><?php echo $count_downline;?></h4>
                    </div>
