                    <div class="row">
                        <div class="col-md-12 m-bottom-30">
                            <div class="bg-white card-body box-shadow-1">
                                <h5 class="text-bold-700 m-bottom-10">NEARBY PROPERTIES</h5>
                                        ...
                                        <div class="property m-bottom-15">
                                            <div class="property-media overlay-wrapper">
                                                ...
                                                <div class="media-data">
                                                    ...
                                                    <div class="position-bottom">
                                                        <h2 class="text-white m-bottom-0 text-bold-700 pull-left"><?php echo $props_price;?></h2>
                                                        <div class="clearfix"></div>
                                                        <!-- <p class="text-white m-bottom-0 pull-left">Per Month</p> -->
                                                        <div class="text-white text-size-18 pull-right line-height-0"><i class="fa fa-camera"></i> <?php echo $count_props_image;?></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="property-section">
                                                <div class="m-top-20 m-bottom-20">
                                                    <h5><a class="text-dark text-base-hover" href="<?php echo base_url();?>view_property/<?php echo $props_id;?>">
                                                    <?php echo $props_name;?>
                                                    </a></h5>
                                                ...
                                                <div class="bg-light-3 p-top-10 p-right-15 p-bottom-10 p-left-15">
                                                    <ul class="list-unstyled d-flex justify-content-between m-bottom-0">
                                                        <li><i class="m-right-4 fa fa-bed"></i> <?php echo $props_bedrom;?>  Beds</li>
                                                        <li><i class="m-right-4 fa fa-tint"></i> <?php echo $props_bathroom;?> Baths</li>
