    ...
    <div class="container">
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-8 text-center-sm">
                <h3 class="text-white text-uppercase text-bold-700 m-bottom-0">Search </h3>
            </div>
                            ...
                            <div class="property bg-white m-bottom-30 box-shadow-1 box-shadow-3-hover">
                                ...
                                <div class="property-section p-left-15 p-right-15">
                                    <div class="m-top-20 m-bottom-20">
                                        ...
                                        <ul class="icon-list list-inline m-bottom-0">
                                            ...
                                            <li class="list-inline-item"><i class="btn btn-base fa fa-tint"></i> 3<?php echo $props_bathroom;?> Baths</li>
                                ...
                                <div class="bg-light-3 text-size-13 text-muted p-top-15 p-right-15 p-bottom-15 p-left-15">
                                    <ul class="list-unstyled d-flex justify-content-between m-bottom-0">
                                        ...
                                        ?>
                                        <li>
                                            <a href="<?php echo base_url();?>Favourite/toogle_favourte/<?php echo $user_id;?>/<?php echo $props_id;?>" class="text-base">
                                            <i class="m-right-4 fa fa-heart" style="color:red;"></i> Favorate</a></li>

                                        <?php }else{?>
                                            <a href="<?php echo base_url();?>Favourite/toogle_favourte/<?php echo $user_id;?>/<?php echo $props_id;?>" class="text-base">
                                            <i class="m-right-4 fa fa-heart-o" style="color:black;"></i> Favorate</a></li>
