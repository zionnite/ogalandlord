...
<footer class="footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <a class="navbar-brand logo" href="index.html">
                                    <img class="full-width max-width-140 m-right-10" style="width:55px;"
                                        src="<?php echo base_url();?>project_dir/<?php echo $get_site_logo;?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="social-icons m-top-15 text-right">
                                    ...
                                    <li>
                                        <a class="btn btn-base rounded-0" target="_blank"
                                            href="<?php echo $get_fb_link;?>"><i class="fa fa-facebook"></i></a>
                                    </li>

                                    <li>
                                        <a class="btn btn-base rounded-0" target="_blank"
                                            href="<?php echo $get_ig_link;?>"><i class="fa fa-instagram"></i></a>
                                    </li>

                                    <li>
                                        <a class="btn btn-base rounded-0" target="_blank"
                                            href="<?php echo $get_tw_link;?>"><i class="fa fa-twitter"></i></a>
                                    </li>
    ...
    <div class="bg-base p-top-30 p-bottom-20">
        <div class="container">
            <p class="text-white m-bottom-6">© Copyright <?php echo date('Y');?> <a
                    class="text-white border-1 border-dotted border-light border-top-0 border-left-0 border-right-0"
                    href="javascript:;"><?php echo $get_site_name;?></a>. All Rights Reserved.</p>
            <div><a href="<?php echo base_url();?>TermsNConditions" style="color:white;">Terms & Condition</a></div>
        </div>
    </div>
</footer>