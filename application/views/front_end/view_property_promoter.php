    ...
    <div class="property">
        <div class="property-media overlay-wrapper p-top-100 p-bottom-50">
            <div class="container p-top-100">
                ...
                <h2 class="text-white text-bold-600 text-size-50 text-size-40-sm m-bottom-10"><?php echo $props_price;?>
            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 m-bottom-50">
                        <div class="bg-white card-body p-top-30 p-bottom-30 p-left-30 p-right-30 box-shadow-1">
                            <h3 class="text-bold-700 m-bottom-10">Call To Action</h3>
                            ...
                            <a class="btn btn-base rounded-0 text-bold-600 text-spacing-5 text-uppercase text-size-13 m-bottom-10 p-left-15 p-right-15 m-right-4"
                                href="<?php echo base_url();?>Request/request_inspection_3/<?php echo $props_id;?>/<?php echo $props_agent_id;?>/<?php echo urlencode($url_code);?>"
                                style="width:100%;">Request
                                For Property Inspection</a>
                        </div>
                    </div>
                </div>
                <!-- /AGENT -->
