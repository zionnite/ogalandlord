...
class Subscription extends My_Controller{
    ...
    public function downline(){
		...
		$config['base_url'] = base_url().'Subscription/downline';
		$config['total_rows'] =$total;
		$config['per_page'] = 50;
		$config['first_link'] = '<li>First</li>';
		$config['full_tag_open'] = '<ul class="pagination">';
        ...
        $data['downline']        =$this->MUser_db->get_my_downline($data['user_id'], $data['offset'], $data['per_page']);

        
        $data['content']                ='back_end/downline';
    ...
    public function transaction(){
		...
		$config['base_url'] = base_url().'Subscription/transaction';
		$config['total_rows'] =$total;
		$config['per_page'] = 50;
		$config['first_link'] = '<li>First</li>';
		$config['full_tag_open'] = '<ul class="pagination">';
