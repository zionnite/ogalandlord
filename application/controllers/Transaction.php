...
class Transaction extends My_Controller {
	...
	public function app_pay($user_id = NULL, $agent_id =NULL, $props_id =NULL){
		...
		$data['content']        ='back_end/app_pay';
		$this->load->view($this->admin_layout,$data);
	}


	public function app_agree($user_id = NULL, $agent_id =NULL, $props_id =NULL){
		$this->Users_db->auth_user($user_id);
